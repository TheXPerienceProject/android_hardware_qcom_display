...
$(warning "Display custom offsets= $(TARGET_USES_CUSTOM_SF_OFFSETS)")
...
ifneq ($(TARGET_DISABLE_DYNAMIC_RR), true)
$(warning TARGET_DISABLE_DYNAMIC_RR: $(TARGET_DISABLE_DYNAMIC_RR))
